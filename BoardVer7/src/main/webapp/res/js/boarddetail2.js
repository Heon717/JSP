var cmtFrmElem = document.querySelector('#cmtForm');
var cmtListElem = document.querySelector('#cmtList');
var cmtModModalElem = document.querySelector('#modal');
var loginUserPk = cmtListElem.dataset.logindata;
function regCmt() {
...
function delAjax(icmt) {
	...
	.then(function(data) {
		...
		switch(data.result) {
			...
			case 1:
				getListAjax();
				cmtModModalElem.className = 'displayName';
			break;
		}
	});
}
...
function modAjax() {
	var cmtModFrmElem = document.querySelector('#cmtModForm');
	var param = {
